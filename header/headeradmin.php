            ...
            <nav class="navbar navbar-default">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="admin.php"><img src="assets/images/logo3.jpg" alt="Logo" /></a>
                    </div>
                    <!-- Collect the nav links, forms, and other content for toggling -->
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            <li class="active"><a href="admin.php">Sản Phẩm</a></li>
                            <li><a href="chart.php">Biểu đồ</a></li>
                            <li><a href="managenew.php">Tin Tức</a></li>
                            <li><a href="manageus.php">Người dùng</a></li>
                        </ul>
                 </div><!-- /.navbar-collapse -->
                    </div><!-- /.container-fluid -->
            </nav>