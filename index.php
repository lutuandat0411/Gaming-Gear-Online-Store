<?php 
 ...
 <div class="container">
	...
	<div class="container bodyperfect">
		<div class="col-md-3">
			<h3 class="title-widget-home" style="border-radius: 5px;">Danh mục</h3>
			<div class="sidebar-home-content">
				<nav class="menu-left">
					<ul class="menu menu-danh-muc">
						...
						<li class="has_child menu-item"><a href="mouseproduct.php">Mouse-Chuột</a></li>
						<li class="has_child menu-item"><a href="headphoneproduct.php">Headphone-Tai Nghe</a></li>
					</ul>
				</nav>
			</div>
			<div class="rowz">
				<img src="/img/asuslogo.png">
				<img src="/img/gigalogo.png">
				<img src="/img/intellogo.png">
			</div>
		</div>
		<div class="col-md-9">
			<nav>
				<div class="row">
					<h3 class="heading" style="border-radius: 5px;">Sản phẩm</h3>
					<div class="container img-product" style="margin-bottom: 10px;" border="1">
							<?php
							require "sqldb.php";
										...
										echo '<div class="col-md-6 col-sm-4 col-lg-2 productshow">';
											echo '<a class="producthover" href="productdetail.php?id='.$row["id"].'">';
												...
												echo '<div class="product-info">';
													...
													echo 	'<div class="product-price"> Giá: '.$row["price"].'đ</div>';
												echo '</div>';
											echo '</a>';
										echo '</div>';
										$col++;
